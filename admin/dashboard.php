...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm mb-4">
    <div class="container-fluid">
        ...
        <div class="d-flex">
            ...
            <a href="users.php" class="btn btn-outline-light btn-sm me-3">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card quick-action h-100">
                <div class="card-body text-center">
                    ...
                    <a href="index.php" class="btn btn-primary">Crear Producto</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card quick-action h-100">
                <div class="card-body text-center">
                    ...
                    <a href="../index.html" class="btn btn-info text-white">Ir a Tienda</a>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="small">
                        ...
                        como proyecto académico de Programación Orientada a Objetos.
                    </p>
                    <p class="small mb-0">
                        <i class="fas fa-users me-1"></i> Desarrollado por Grupo 5<br>
